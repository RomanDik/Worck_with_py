...
if __name__ == "__main__":
    ...
    # 2. сделать чтобы многократное нажатие равно давало новые значения =================completed
    # 3. 3-х значное число ломает равно =================completed
    # не помню =================completed
    # не нажимать 00000 после - =================completed
    # проверка на is digit =================completed
    ...
    # 1.Тупое равно после ** =================completed
    # 2. sqrt тоже тупое с = =================completed
    # 3. чет было в выводе не так с 0 не помню =================completed
    # 4. опять забыл Логарифм и е-гарифм =================completed
    # 5. память сделать
    # 6. исключения логарифа. =================completed
    # 7. смена инженерки =================completed
    # 8. нумпад активный (Qt.key_x) через мач кейс =================completed
    # 9. коприрование =================completed
    # 10. процент =================completed